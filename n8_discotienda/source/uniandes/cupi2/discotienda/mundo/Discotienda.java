...
public class Discotienda
{
    ...
    //Integrantes: Karen Erazo y Johan Serrano
    public void generarReciboDIscosCostosos() throws FileNotFoundException{
    	File discosCostososRyP = new File("./data/reporteDiscoCostosos.txt");
    	PrintWriter pluma2 = new PrintWriter(discosCostososRyP);
    	pluma2.println("Reporte discos Rock y Pop de 3500");
    	pluma2.println("============================");
    	for ( int i =0 ;  i< discos.size() ; i ++ ) {
    		Disco miDisco = (Disco)discos.get(i);
    		if(miDisco.darGenero().equals("Rock")|| miDisco.darGenero().equals("Pop")) {
    			if(miDisco.darPrecioDisco()>3500) {
    			pluma2.println("Disco: "+ miDisco.darNombreDisco());
    			pluma2.println("Genero:"+ miDisco.darGenero());
    			pluma2.println("Precio: "+ miDisco.darPrecioDisco());
    			pluma2.println("------------------------------------");
    			}
    		}
    	}
    ...
    public String metodo1( )
    {
    	...
    	try {
			...
			return("Error al generar el reporte, tipo: "+ er);
		}
    }
